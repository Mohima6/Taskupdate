...
# ========== CONFIGURATION ==========
# Set the folder where your PLI Gamma result files are located
BASE_PATH = r"C:\Users\mohimaCHAKRABORTY\Taskupdate\machine_learning\results\PLI\gamma"
...
OUTPUT_PDF = os.path.join(BASE_PATH, "PLI_gamma_classification_report.pdf")
...
# ========== MAIN ==========
print("Generating PDF report for PLI Gamma band...")
