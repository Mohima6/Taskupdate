...
# ========== CONFIGURATION ==========
# Set the folder where your wPLI Theta result files are located
BASE_PATH = r"C:\Users\mohimaCHAKRABORTY\Taskupdate\machine_learning\results\wPLI\theta"
...
OUTPUT_PDF = os.path.join(BASE_PATH, "wPLI_theta_classification_report.pdf")
...
# ========== MAIN ==========
print("Generating PDF report for wPLI Theta band...")
