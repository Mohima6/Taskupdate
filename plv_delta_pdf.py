...
# ========== CONFIGURATION ==========
# Set the folder where your PLV Delta result files are located
BASE_PATH = r"C:\Users\mohimaCHAKRABORTY\Taskupdate\machine_learning\results\PLV\delta"
...
OUTPUT_PDF = os.path.join(BASE_PATH, "PLV_delta_classification_report.pdf")
...
# ========== MAIN ==========
print("Generating PDF report for PLV Delta band...")
