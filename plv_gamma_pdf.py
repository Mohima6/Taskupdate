...
# ========== CONFIGURATION ==========
# Set the folder where your PLV Gamma result files are located
BASE_PATH = r"C:\Users\mohimaCHAKRABORTY\Taskupdate\machine_learning\results\PLV\gamma"
...
OUTPUT_PDF = os.path.join(BASE_PATH, "PLV_gamma_classification_report.pdf")
...
# ========== MAIN ==========
print("Generating PDF report for PLV Gamma band...")
