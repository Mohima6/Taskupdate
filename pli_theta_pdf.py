...
# ========== CONFIGURATION ==========
# Set the folder where your PLI Theta result files are located
BASE_PATH = r"C:\Users\mohimaCHAKRABORTY\Taskupdate\machine_learning\results\PLI\theta"
...
OUTPUT_PDF = os.path.join(BASE_PATH, "PLI_theta_classification_report.pdf")
...
# ========== MAIN ==========
print("Generating PDF report for PLI Theta band...")
