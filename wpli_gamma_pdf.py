...
# ========== CONFIGURATION ==========
# Set the folder where your wPLI Gamma result files are located
BASE_PATH = r"C:\Users\mohimaCHAKRABORTY\Taskupdate\machine_learning\results\wPLI\gamma"
...
OUTPUT_PDF = os.path.join(BASE_PATH, "wPLI_gamma_classification_report.pdf")
...
# ========== MAIN ==========
print("Generating PDF report for wPLI Gamma band...")
