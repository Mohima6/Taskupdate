...
# ========== CONFIGURATION ==========
# Set the folder where your PLI Delta result files are located
BASE_PATH = r"C:\Users\mohimaCHAKRABORTY\Taskupdate\machine_learning\results\PLI\delta"
...
OUTPUT_PDF = os.path.join(BASE_PATH, "PLI_delta_classification_report.pdf")
...
# ========== MAIN ==========
print("Generating PDF report for PLI Delta band...")
