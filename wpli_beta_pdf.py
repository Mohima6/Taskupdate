...
# ========== CONFIGURATION ==========
# Set the folder where your wPLI Beta result files are located
BASE_PATH = r"C:\Users\mohimaCHAKRABORTY\Taskupdate\machine_learning\results\wPLI\beta"
...
OUTPUT_PDF = os.path.join(BASE_PATH, "wPLI_beta_classification_report.pdf")
...
# ========== MAIN ==========
print("Generating PDF report for wPLI Beta band...")
