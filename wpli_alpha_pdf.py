...
# ========== CONFIGURATION ==========
# Set the folder where your wPLI Alpha result files are located
BASE_PATH = r"C:\Users\mohimaCHAKRABORTY\Taskupdate\machine_learning\results\wPLI\alpha"
...
OUTPUT_PDF = os.path.join(BASE_PATH, "wPLI_alpha_classification_report.pdf")
...
# ========== MAIN ==========
print("Generating PDF report for wPLI Alpha band...")
