...
# ========== CONFIGURATION ==========
# Set the folder where your PLV Beta result files are located
BASE_PATH = r"C:\Users\mohimaCHAKRABORTY\Taskupdate\machine_learning\results\PLV\beta"
...
OUTPUT_PDF = os.path.join(BASE_PATH, "PLV_beta_classification_report.pdf")
...
# ========== MAIN ==========
print("Generating PDF report for PLV Beta band...")
